...
const reasons = [
  {
    ...
    description: {
      ...
      hi: "स्मार्ट टीवी, प्लेस्टेशन, Xbox, Chromecast, Apple TV, ब्लू-रे प्लेयर और भी बहुत कुछ पर देखें।",
    },
    icon: (
    ...
    bg: "bg-gradient-to-b from-[#1A0F2E] to-[#0B0B0B]",
  },
  {
    id: 2,
    title: {
    ...
    description: {
      en: "Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV without paying more.",
      hi: "अपने फोन, टैबलेट, लैपटॉप और टीवी पर असीमित फिल्में और टीवी शो स्ट्रीम करें, बिना अधिक भुगतान किए।",
    },
    icon: (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
  ...
  },
  {
    id: 3,
    title: {
      en: "Download your shows",
      hi: "अपने शो डाउनलोड करें",
    },
    description: {
      en: "Save your favorites easily and always have something to watch offline.",
      hi: "अपने पसंदीदा शो आसानी से सहेजें और हमेशा ऑफ़लाइन देखने के लिए कुछ न कुछ रखें।",
    },
    icon: (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
  ...
  },
  {
    ...
    description: {
      en: "Send kids on adventures with their favorite characters in a space made just for them—free with your membership.",
      hi: "बच्चों को उनके पसंदीदा पात्रों के साथ रोमांच पर भेजें, उनके लिए बनाई गई जगह में—आपकी सदस्यता के साथ मुफ्त।",
    },
    icon: (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
...
export default function MoreReasons() {
  type LangKey = "en" | "hi"; 
  const lang = useAppSelector((state: RootState) => state.language.code) as LangKey;
  return (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {reasons.map((reason) => {
            ...
            return (
              <div
                key={reason.id}
                className={`relative rounded-2xl p-6 min-h-[300px] flex flex-col justify-between ${reason.bg}`}
              >
                {/* Title + Description */}
                <div>
